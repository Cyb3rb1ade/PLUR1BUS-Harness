...
| 69 | ACP `registry.mdx:112`, `:121`, `:168`, `:629`, `:685` | `agentclientprotocol/claude-agent-acp`; Claude Agent 0.79.0, Codex 1.12.0, Gemini CLI 0.60.0, goose 1.51.0 | **confirmed** (exact, all five) |
