...
| Path | Format | Schema/version | Source | Harness mapping | Secrets? |
|---|---|---|---|---|---|
| `SOUL.md` | Markdown, freeform | n/a | Part B1; migration target confirmed `openclaw_to_hermes.py:1273,1277` | → the target agent's **persona file** `persona.md` (auftrag §5: "Genau eine Soul pro Agent"; renamed by ADR-003, Q8) | No |
