...
// Task 16 verified count: openclaw.plugin.json configSchema.properties has 54 keys at engine SHA
// eaaf168f (contract 1.4.1), not the 56 the earlier M1a-era research and the H1 spec/plan assumed.
// The pinned engine's key set moved between the two counts; this assertion catches a future drift.
const EXPECTED_KEY_COUNT = 54;
